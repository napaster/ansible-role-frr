...
frr:
  ...
  - enable: 'true'
    # Restart frr service after deploy or not. Actually restart is not
    # performed, only 'reload' (merge current configuration in RAM with
    # 'frr.conf')
    restart: 'true'
    ...
    init_options:
      - max_fds: '1024'
        ...
        watchfrr_options:
          "-d -r '/usr/bin/frr restart %s' -s '/usr/bin/frr start %s' -k '/usr/bin/frr stop %s'"
    settings:
      - zebra:
          - hostname: 'R1'
            log_commands: 'true'
            ...
            # VRRP logs actions taken by the Neighbor Discovery component of
            # VRRP
            debug_vrrp_ndisc: 'true'
            # VRRP logs details of ingress and egress packets. Includes packet
            # decodes and hex dumps
            debug_vrrp_packets: 'true'
            # VRRP logs state changes, election protocol decisions, and
              ...
              - as_num: '198181'
                ...
                neighbors:
                  ...
                  - neighbor: '178.49.129.89'
                    ...
                    # To enable, you must set your local role to reflect your
                    # type of peering relationship with your neighbor. Possible
                    # values are: 'provider', 'rs-server', 'rs-client',
                    # 'customer', 'peer'
                    local_role:
                      - role: 'peer'
                    # If strict-mode is set BGP session won’t become established
                    # until BGP neighbor set local Role on its side. This
                    # configuration parameter is defined in RFC 9234 and used
                    # to enforce corresponding configuration at your
